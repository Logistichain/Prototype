...
namespace Mpb.Consensus.BlockLogic
{
    ...
    public interface IPowBlockCreator
    {
        ...
        Block CreateValidBlock(string privateKey, IEnumerable<AbstractTransaction> transactions, BigDecimal difficulty);
        ...
        /// <returns>A valid block that meets the consensus conditions</returns>
        Block CreateValidBlock(string privateKey, IEnumerable<AbstractTransaction> transactions, BigDecimal difficulty, CancellationToken ct);
        ...
        Block CreateValidBlock(string privateKey, string netIdentifier, uint protocolVersion, IEnumerable<AbstractTransaction> transactions, BigDecimal difficulty, BigDecimal maximumTarget, CancellationToken ct);
    }
}