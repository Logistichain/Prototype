...
using Moq;
using Logistichain.Consensus.Test.Mocks;
...
namespace Logistichain.Consensus.Test.Logic.StateTransactionValidators
{
    /// <summary>
    ...
    public class TransactionValidatorTest
    {
        ...
        {
            var consensusNetworkIdentifier = "testnet"; //! change this whenever the networkidentifier changes in the Logistichain.consensus assembly!
        ...
        {
            uint consensusTransactionVersion = 1; //! change this whenever the networkidentifier changes in the Logistichain.consensus assembly!
